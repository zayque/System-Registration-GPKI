                    ...
                    <div class="card mb-4">
                        <div class="title">
                            ...
                            <center>
                                ...
                                <?php
                                    ...
                                    foreach ($_POST['zon'] as $select)
                                    {
                                                        ...
                                                        switch($zon){
                                                            case "Tengah":
                                                            $negeri1 =  mysqli_query($conn,"select count(negeri_user) as put from user where negeri_user = 'Putrajaya' and jenis = 'Latihan'");
                                                            $negeri1= mysqli_fetch_array($negeri1);
                                                            $negeri2 =  mysqli_query($conn,"select count(negeri_user) as kul from user where negeri_user = 'Kuala Lumpur' and jenis = 'Latihan'");
                                                            $negeri2= mysqli_fetch_array($negeri2);
                                                            $negeri3 =  mysqli_query($conn,"select count(negeri_user) as sel from user where negeri_user = 'Selangor' and jenis = 'Latihan'");
                                                            ...
                                                            case "Timur":
                                                            $negeri1 =  mysqli_query($conn,"select count(negeri_user) as kel from user where negeri_user = 'Kelantan' and jenis = 'Latihan'");
                                                            $negeri1= mysqli_fetch_array($negeri1);
                                                            $negeri2 =  mysqli_query($conn,"select count(negeri_user) as ter from user where negeri_user = 'Terengganu' and jenis = 'Latihan'");
                                                            $negeri2= mysqli_fetch_array($negeri2);
                                                            $negeri3 =  mysqli_query($conn,"select count(negeri_user) as pah from user where negeri_user = 'Pahang' and jenis = 'Latihan'");
                                                            $negeri3= mysqli_fetch_array($negeri3);
                                                            echo "<br>";
                                                            echo "<b>Negeri</b>";
                                                            echo "<br><br>";
                                                            ...
                                                            case "Utara":
                                                            $negeri1 =  mysqli_query($conn,"select count(negeri_user) as per from user where negeri_user = 'Perlis' and jenis = 'Latihan'");
                                                            $negeri1= mysqli_fetch_array($negeri1);
                                                            $negeri2 =  mysqli_query($conn,"select count(negeri_user) as ked from user where negeri_user = 'Kedah' and jenis = 'Latihan'");
                                                            $negeri2= mysqli_fetch_array($negeri2);
                                                            $negeri3 =  mysqli_query($conn,"select count(negeri_user) as pul from user where negeri_user = 'Pulau Pinang' and jenis = 'Latihan'");
                                                            $negeri3= mysqli_fetch_array($negeri3);
                                                            $negeri4 =  mysqli_query($conn,"select count(negeri_user) as perak from user where negeri_user = 'Perak' and jenis = 'Latihan'");
                                                            ...
                                                            case "Selatan":
                                                            $negeri1 =  mysqli_query($conn,"select count(negeri_user) as joh from user where negeri_user = 'Johor' and jenis = 'Latihan'");
                                                            $negeri1= mysqli_fetch_array($negeri1);
                                                            $negeri2 =  mysqli_query($conn,"select count(negeri_user) as neg from user where negeri_user = 'Negeri Sembilan' and jenis = 'Latihan'");
                                                            $negeri2= mysqli_fetch_array($negeri2);
                                                            $negeri3 =  mysqli_query($conn,"select count(negeri_user) as mel from user where negeri_user = 'Melaka' and jenis = 'Latihan'");
                                                            $negeri3= mysqli_fetch_array($negeri3);
                                                            echo "<br>";
                                                            echo "<b>Negeri</b>";
                                                            echo "<br><br>";
                                                            ...
                                                            case "Sabah":
                                                            $negeri1 =  mysqli_query($conn,"select count(negeri_user) as sab from user where negeri_user = 'Sabah' and jenis = 'Latihan'");
                                                            $negeri1= mysqli_fetch_array($negeri1);   
                                                            echo "<br>";
                                                            echo "<b>Negeri</b>";
                                                            echo "<br><br>";
                                                            ...
                                                            case "Sarawak":
                                                            $negeri1 =  mysqli_query($conn,"select count(negeri_user) as sar from user where negeri_user = 'Sarawak' and jenis = 'Latihan'");
                                                            $negeri1= mysqli_fetch_array($negeri1);  
                                                            echo "<br>";
                                                            echo "<b>Negeri</b>";
                                                            echo "<br><br>";
                            ...
                            <center>
                                <br>
                                <b>
                                    <p>SENARAI KEHADIRAN LATIHAN<br> PRASARANA KEKUNCI AWAM KERAJAAN (GOVERNMENT PUBLIC
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover" cellpadding="10" cellspacing="1">
                                      ...
                                      ?>
                                            <tr>
                                                <td><input type="checkbox" name="no" onchange="handleChange(this);"
                                                        value="<?=$result[$k]["noic_user"];?>" /></td>
                                                ...
                                                <td>
                                                    <a href="edituser.php?noic_user=<?php echo $result[$k]["noic_user"]; ?>">Kemaskini</a>
                                                    <br>
                                                    <a href="deleteuser.php?action=delete&noic_user=<?php echo $result[$k]["noic_user"]; ?>"
                                                        onClick="return confirm('Anda pasti ?');">Padam</a>
                                                    <!-- <button id="opener">Display</button> -->
                                                </td>
                                            </tr>
                                            <?php
                                          }
