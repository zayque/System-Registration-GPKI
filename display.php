...
<body class="body-from">
        ...
        <div class="info">
            <table>
                <tr>
                    ...
                    <td>
                        <div style="padding-left: 20px"><?php echo $row['maklumat_detail'];?></div>
                    </td>
                </tr>
                <tr>
                    <th>Tarikh : </th>
                    <td>
                        <div style="padding-left: 20px"><?php echo $row['maklumat_tarikh'];?></div>
                    </td>
                </tr>
                <tr>
                    <th>Hari : </th>
                    <td>
                        <div style="padding-left: 20px"><?php echo $row['maklumat_hari'];?></div>
                    </td>
                </tr>
                <tr>
                    <th>Masa : </th>
                    <td>
                        <div style="padding-left: 20px"><?php echo $row['maklumat_masa'];?></div>
                    </td>
                </tr>
                <tr>
                    <th>Lokasi : </th>
                    <td>
                        <div style="padding-left: 20px"><?php echo $row['maklumat_tempat'];?></div>
                    </td>
                </tr>
                <tr>
                    <th></th>
                    <td>
                        <div style="padding-left: 20px"><?php echo $row['maklumat_tempat2'];?></div>
                    </td>
                </tr>
                <tr>
                    <th></th>
                    <td>
                        <div style="padding-left: 20px"><?php echo $row['maklumat_tempat4'];?></div>
                    </td>
                </tr>
                <tr>
                    <th></th>
                    <td>
                        <div style="padding-left: 20px"><?php echo $row['maklumat_tempat3'];?></div>
                    </td>
                </tr>
    ...
    <center>
        ...
        <b>
            <p>SENARAI KEHADIRAN LATIHAN<br>PRASARANA KEKUNCI AWAM KERAJAAN (GOVERNMENT PUBLIC KEY INFRASTRUCTURE
                (GPKI))</p>
        </b>
        ...
        <div class="table-responsive">
          ...
          ?>
                            <tr>
                                ...
                                <td style="border: 1px solid black;"><?php echo strtoupper($result[$k]["nama_user"]);?>
                                </td>
                                <td style="border: 1px solid black;"><?php echo $result[$k]["peranan_user"]; ?></td>
                                <td style="border: 1px solid black;">
                                    <?php echo strtoupper($result[$k]["agensi_user"]);?> </td>
