                    ...
                    <nav class="navbar navbar-expand-lg ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active_nav" href="seminar.php" style="color:#6fa8dc;">SEMINAR</a>
                                </li>
                                <li class="nav-item">
        ...
        <div class="services_main">
            <div class="container">
                <div class="creative_taital">
                    <h1 class="creative_text">Seminar Event</h1> <br>
                    <?php while($row = mysqli_fetch_array($result)){?>
                    <p class="text_about_2" style="color: #000000; ">
                        <a style="color:blue; font-weight:bold; font-size:24px;">Maklumat Latihan :</a> <?php echo $row['maklumat_detail2'];?>
                        <br><br>
                        <a style="color:blue; font-weight:bold; font-size:24px;">Zon :</a> <?php echo $row['maklumat_zon2'];?>
                        <br><br>
                        <a style="color:blue; font-weight:bold; font-size:24px;"> Negeri :</a> <?php echo $row['maklumat_negeri2'];?>
                        <br><br>
                        <a style="color:blue; font-weight:bold; font-size:24px;">Tarikh :</a> <?php echo $row['maklumat_tarikh2'];?>
                        <br><br>
                        <a style="color:blue; font-weight:bold; font-size:24px;">Hari :</a> <?php echo $row['maklumat_hari2'];?>
                        <br><br>
                        <a style="color:blue; font-weight:bold; font-size:24px;">Masa :</a>  <?php echo $row['maklumat_masa2'];?>
                        <br><br>
                        <a style="color:blue; font-weight:bold; font-size:24px;">Tempat :</a> <?php echo $row['maklumat_tempat22'];?>, 
                        <?php echo $row['maklumat_tempat23'];?>  <?php echo $row['maklumat_tempat24'];?>
