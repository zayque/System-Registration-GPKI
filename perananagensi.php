    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <?php
                    ...
                    $peranan1 =  mysqli_query($conn,"select count(peranan_user) as pengguna from user where peranan_user = 'PENGGUNA' and jenis = 'Latihan'");
                    $peranan2 =  mysqli_query($conn,"select count(peranan_user) as authorized from user where peranan_user = 'AUTHORIZED PERSONNEL(AP)' and jenis = 'Latihan'");
                    $peranan3 =  mysqli_query($conn,"select count(peranan_user) as sub from user where peranan_user = 'SUB ADMIN(SA)' and jenis = 'Latihan'");
                    // $peranan4 =  mysqli_query($conn,"select count(peranan_user) as pen from user where peranan_user = 'PENGURUSAN' and jenis = 'Latihan'");
            ...
            <center>
                <div style="width:80%; border: 1px solid rgb(221,221,221); border-radius:4px;">
                    <div class="peranan">
                        ...
                        <br>
                        <label for=""><b>PERANAN AGENSI LATIHAN</b></label>
                        <br>
                ...
                $sistem1 =  mysqli_query($conn,"select count(sistem_user) as igf from user where sistem_user like '%iGFMAS,%' and jenis = 'Latihan'");
                $sistem2 =  mysqli_query($conn,"select count(sistem_user) as epe from user where sistem_user like '%ePerolehan,%' and jenis = 'Latihan'");

                $sistem3 =  mysqli_query($conn,"select count(sistem_user) as pow from user where sistem_user like '%POWER Gen 2,%' and jenis = 'Latihan'");
                $sistem4 =  mysqli_query($conn,"select count(sistem_user) as eve from user where sistem_user like '%eVetting,%' and jenis = 'Latihan'");

                $sistem5 =  mysqli_query($conn,"select count(sistem_user) as esy from user where sistem_user like '%E-Syariah,%' and jenis = 'Latihan'");
                $sistem6 =  mysqli_query($conn,"select count(sistem_user) as eke from user where sistem_user like '%eKehakiman,%' and jenis = 'Latihan'");

                $sistem7 =  mysqli_query($conn,"select count(sistem_user) as myg from user where sistem_user like '%MyGST,%' and jenis = 'Latihan'");
                $sistem8 =  mysqli_query($conn,"select count(sistem_user) as nc from user where sistem_user like '%NC4,%' and jenis = 'Latihan'");

                $sistem9 =  mysqli_query($conn,"select count(sistem_user) as eta from user where sistem_user like '%eTanah,%' and jenis = 'Latihan'");
                $sistem10 =  mysqli_query($conn,"select count(sistem_user) as eka from user where sistem_user like '%eKampus,%' and jenis = 'Latihan'");

                $sistem11 =  mysqli_query($conn,"select count(sistem_user) as ins from user where sistem_user like '%INSIST,%' and jenis = 'Latihan'");
                $sistem12 =  mysqli_query($conn,"select count(sistem_user) as myc from user where sistem_user like '%MyCukai,%' and jenis = 'Latihan'");

                $sistem13 =  mysqli_query($conn,"select count(sistem_user) as mye from user where sistem_user like '%MyeTaPP,%' and jenis = 'Latihan'");
                $sistem14 =  mysqli_query($conn,"select count(sistem_user) as ucu from user where sistem_user like '%uCustom,%' and jenis = 'Latihan'");

                $sistem15 =  mysqli_query($conn,"select count(sistem_user) as ero from user where sistem_user like '%eROSA,%' and jenis = 'Latihan'");
                $sistem16 =  mysqli_query($conn,"select count(sistem_user) as mygd from user where sistem_user like '%MyGDX,%' and jenis = 'Latihan'");
                $sistem17 =  mysqli_query($conn,"select count(sistem_user) as ekad from user where sistem_user like '%eKadaster,%' and jenis = 'Latihan'");
