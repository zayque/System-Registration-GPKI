                        ...
                        <div class="title">
                            ...
                            <div class="form-group">
                                ...
                                <div class="btn-latihan">
                                    <a href="editmaklumat2.php?maklumat_id2=<?php echo $row['maklumat_id2'];?>"><button
                                            class="btn btn-primary">Kemaskini</button></a>
                                    <a href="borangseminar.php"><button class="btn btn-success"
                                            <?php if($seminar1 > $jumlahseminar1) echo "disabled"; ?>>Borang</button></a>
                                </div>
                                <br><br>
                                <hr>
                                <br>
                                <center>
                                    <label for="Name" class="col-lg-5 col-md-5 col-sm-5 col-xs-5 control-label"><b>
                                            Limit Seminar Borang </b> : <?php echo $row['jumlah_limit2'];?></label>
                                    <br><br>
                                    <a href="editlimitseminar.php?id_limit2=<?php echo $row['id_limit2'];?>"><button
                                            class="btn btn-primary">Kemaskini</button></a>
                                </center>
                            </div>
                            ...
                            <center>
                                ...
                                <label for="Name" class="col-lg-3 col-md-3 col-sm-3 col-xs-3 control-label"><b>Jumlah
                                        Seminar Berdaftar </b> <?php echo $seminar1;?>/<?php echo $jumlahseminar1;?>
                                ...
                                function drawChart() {
                                    var data = google.visualization.arrayToDataTable([
                                        ['Seminar', 'Bilangan'],
                                        ['Seminar', <?php echo $seminar1;?>],
                                        ['Jumlah', <?php echo $jumlahseminar1;?>]
                                    ]);
                                ...
                                <div class="zon-content">
                                    ...
                                    <label for="Name" class="col-lg-3 col-md-3 col-sm-3 col-xs-3 control-label">
                                        <b>Status SEMINAR Peserta </b>


                                    </label>
                                    <div class="container" style="width:30%">
                                        <div class="row row-cols-auto">
                                            <div class="col" style="border:1px solid gray;">Zon Selatan </div>
                                            <div class="col" style="border:1px solid gray">
                                                <?php echo $selatanseminar1;?></div>
                                        </div>
                                        <div class="row row-cols-auto">
                                            <div class="col" style="border:1px solid gray">Zon Tengah</div>
                                            <div class="col" style="border:1px solid gray"><?php echo $tengahseminar1;?>
                                            </div>
                                        </div>
                                        <div class="row row-cols-auto">
                                            <div class="col" style="border:1px solid gray">Zon Sabah</div>
                                            <div class="col" style="border:1px solid gray"><?php echo $sabahseminar1;?>
                                            </div>
                                        </div>
                                        <div class="row row-cols-auto">
                                            <div class="col" style="border:1px solid gray">Zon Sarawak</div>
                                            <div class="col" style="border:1px solid gray">
                                                <?php echo $sarawakseminar1;?></div>
                                        </div>
                                    </div>
                                    <br><br>
                                    ...
                                    function drawStuff() {
                                        var data = new google.visualization.arrayToDataTable([
                                            ['Peserta', 'Jumlah'],
                                            ["Zon Selatan", <?php echo $selatanseminar1;?>],
                                            ["Zon Tengah", <?php echo $tengahseminar1;?>],
                                            ["Zon Sabah", <?php echo $sabahseminar1;?>],
                                            ["Zon Sarawak", <?php echo $sarawakseminar1;?>]
                                        ]);
